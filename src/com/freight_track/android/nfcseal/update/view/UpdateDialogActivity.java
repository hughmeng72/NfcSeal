package com.freight_track.android.nfcseal.update.view;
...
import com.freight_track.android.nfcseal.update.util.FileUtils;
import com.freight_track.android.nfcseal.update.util.InstallUtil;
import com.freight_track.android.nfcseal.update.util.NetworkUtil;
import com.freight_track.android.nfcseal.update.util.ResourceUtils;
import com.freight_track.android.nfcseal.update.util.UpdateConstants;
import com.freight_track.android.nfcseal.update.util.UpdateSP;
...
public class UpdateDialogActivity extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        int layoutId = UpdateSP.getDialogLayout();
        if (layoutId > 0) {
